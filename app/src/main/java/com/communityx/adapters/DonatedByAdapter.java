...
public class DonatedByAdapter extends RecyclerView.Adapter<DonatedByAdapter.EventHolder> {
    private ArrayList<String> mLikesList;
    private Activity mActvity;
    private LayoutInflater mLayoutInflater;

    public DonatedByAdapter(ArrayList<String> likesList, Activity activity) {
    ...
    public EventHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        return new DonatedByAdapter.EventHolder(view);
    }
